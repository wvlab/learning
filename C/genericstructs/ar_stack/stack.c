...
/* Конструктор стека */
stack_t *
_newStack (size_t __size, size_t __len)
{
 ...
 */
bool
pushStack (stack_t* stack, void* data)
{
...
bool
isStackEmpty (const stack_t* stack)
{
    if (stack == NULL)
      {
...
bool
isStackFull (const stack_t* stack)
{
    if (stack == NULL)
      {
        fprintf(stderr, "Stack doesn't exist anymore\n");
